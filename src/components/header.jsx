...
import { GiHalfBodyCrawling, GiHamburgerMenu } from "react-icons/gi";
...
export default function Header(){
    ...
    return(
        <header className="w-full h-[80px] shadow-2xl flex justify-center relative">
            ...
            }/>   {/* text-3xl kiynne size ek,md:hidden kiynne median device wl idn loku screen wlt yn kot mek hidden weno,absolute left-2 absolute krgen pixel dekk left ekt gnno*/}
            <img onClick={()=>{
                navigate("/")
            }} src="/logo.png" alt="Logo" className="w-[80px] h-[80px] object-cover cursor-pointer"/>     {/*object-cover ek mgin logo ek hriyt thiyeno */}
            <div className="w-[calc(100%-160px)] h-full hidden md:flex  justify-center items-center">   {/* hidden ekn krnne phone wldi penne nethuw yno,md:flex wlin krnne median device wldi ew penno */}
            ...
            {
                SideDrawerOpened&&  // SideDrawerOpened ek open nm withrk penn 

						...
						{activeOrder && (
							<div className="space-y-4">
										...
										<p>
											...
											<select
												...
												onChange={async (e) => {
													...
													if (!updatedValue) return; // Don't process empty selection
								...
								{activeOrder.products && activeOrder.products.length > 0 ? (
										...
										<tbody>
											{activeOrder.products.map((item, idx) => (
												...
												>
													...
													<td className="py-2 px-2">{item.productInfo?.name || 'N/A'}</td>
													<td className="py-2 px-2">
													...
													<td className="py-2 px-2">
														{item.productInfo?.price ? (
															(item.productInfo.price * (item.quantity || 0)).toLocaleString("en-LK", {
																style: "currency",
																currency: "LKR",
															})
														) : 'N/A'}
									...
									<p className="text-gray-500 text-center py-4">No products found for this order.</p>
								)}
								<div className="flex justify-end">
									<button
										onClick={() => setIsModalOpen(false)}
										className="mt-4 px-4 py-2 bg-[var(--color-accent)] text-white rounded hover:bg-[var(--color-secondary)] transition mr-2"
									>
										Close
									</button>
									<button
